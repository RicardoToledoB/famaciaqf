...
import com.farmacia.v1.repository.ChemicalTestRepository;
import com.farmacia.v1.repository.CommuneRepository;
import com.farmacia.v1.service.IChemicalTestService;
...
@Service
public class ChemicalTestServiceImpl implements IChemicalTestService {

    @Autowired
    private ChemicalTestRepository repository;


    private ChemicalTestDTO mapToDTO(ChemicalTestEntity entity) {
        return ChemicalTestDTO.builder()
                .id(entity.getId())
    ...
    private ChemicalTestEntity mapToEntity(ChemicalTestDTO dto) {
        return ChemicalTestEntity.builder()
                .id(dto.getId())
    ...
    public ChemicalTestDTO create(ChemicalTestDTO dto) {
        ChemicalTestEntity entity = repository.save(mapToEntity(dto));
     ...
     */
    @Override
    public ChemicalTestDTO update(Integer id, ChemicalTestDTO dto) {
        ChemicalTestEntity entity = repository.findById(id)
    ...
    @Override
    public ChemicalTestDTO getById(Integer id) {
        ChemicalTestEntity entity = repository.findById(id)
                .orElseThrow(() -> new RuntimeException("Task not found"));
        return mapToDTO(entity);
    }
    ...
    @Override
    public List<ChemicalTestDTO> getAll() {
    ...
    public Page<ChemicalTestDTO> getAllPaginated(Pageable pageable) {
        return repository.findAllPaginated(pageable)
                .map(this::mapToDTO);
    }

    public Page<ChemicalTestDTO> getAllPaginated(String name, Pageable pageable) {
    ...
    public List<ChemicalTestDTO> listAll() {
    ...
    public List<ChemicalTestDTO> listActive() {
    ...
    public List<ChemicalTestDTO> listDeleted() {
    ...
    public void restore(Integer id) {
        ChemicalTestEntity entity = repository.findAnyById(id)
                .orElseThrow(() -> new RuntimeException("Task not found"));
