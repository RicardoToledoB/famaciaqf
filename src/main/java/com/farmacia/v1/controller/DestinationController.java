...
import com.farmacia.v1.service.impl.DestinationServiceImpl;
...
public class DestinationController {
    ...
    public ResponseEntity<Page<DestinationDTO>> getAllPaginated(
    ...
    @PutMapping("/{id}")
    public ResponseEntity<DestinationDTO> update(@PathVariable Integer id, @RequestBody DestinationDTO dto) {
    ...
    /* SOFT DELETE */
    @GetMapping
    public ResponseEntity<List<DestinationDTO>> listActive() {
        return ResponseEntity.ok(service.listActive());
    }

    @GetMapping("/deleted")
    public ResponseEntity<List<DestinationDTO>> listDeleted() {
