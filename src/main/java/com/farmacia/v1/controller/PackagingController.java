...
import com.farmacia.v1.service.impl.PackagingServiceImpl;
...
@RestController
@RequestMapping("/api/v1/packagings")
@CrossOrigin("*")
public class PackagingController {
    ...
    public ResponseEntity<Page<PackagingDTO>> getAllPaginated(
    ...
    /* SOFT DELETE */
    @GetMapping
    public ResponseEntity<List<PackagingDTO>> listActive() {
        return ResponseEntity.ok(service.listActive());
    }

    @GetMapping("/deleted")
    public ResponseEntity<List<PackagingDTO>> listDeleted() {
